...
const std::array<AttributeInfo, 2> TerrainShaderSource::attributes = {
    AttributeInfo{terrainUBOCount + 0, gfx::AttributeDataType::Short2, terrainUBOCount + 0, idTerrainPosVertexAttribute},
    AttributeInfo{terrainUBOCount + 1, gfx::AttributeDataType::Short2, terrainUBOCount + 1, idTerrainTexturePosVertexAttribute},
};
